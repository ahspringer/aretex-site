      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {founders.map((founder) => (
            ...
            >
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-lg border border-dashed border-teal-600/25 bg-gradient-to-br from-teal-600/8 via-transparent to-copper/8 flex items-center justify-center">
